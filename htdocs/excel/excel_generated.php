...
// $sheet->getRowDimension('0.5')->setRowHeight(150);
// $sheet->getColumnDimensionByColumn($columnIndex)->setWidth(150);

// Save the Excel file
$writer = new Xlsx($spreadsheet);
$excelFileName = 'watches_data.xlsx'; // Adjust the filename as needed

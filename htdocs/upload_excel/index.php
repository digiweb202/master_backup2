        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                foreach ($worksheet->getRowIterator() as $row) {
                    ...
                    // $stmt4 = $conn->prepare("INSERT INTO watches_discovery (
                    //     Target_Audience1,
                    //     Target_Audience2,
                    //     Target_Audience3,
                    //     Target_Audience4,
                    ...
                    //     Additional_Features1,
                    //     Additional_Features2,
                    //     Additional_Features3,
                    //     Additional_Features4,
                    //     Additional_Features5,
                    //     `Character`,
                    //     Sport1,
                    //     Sport2,
                    //     Sport3,
                    //     `Collection`,
                    //     Case_Thickness_Unit_of_Measure,
                    //     Band_Length,
                    //     Packer,
                    //     Item_Type_Name,
                    //     Operating_Systems,
                    ...
                    $stmt9->bind_param("ssssssssssssssssssssss", $values[144],$values[145],$values[146],$values[147],$values[148],$values[149],$values[150],$values[151],$values[152],$values[153],$values[154],$values[155],$values[156],$values[157],$value[158],$values[159],$values[160],$values[161],$values[162],$values[163],$values[164],$values[165]);
                    if (!$stmt9->execute()) {
